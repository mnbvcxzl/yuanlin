package com.yuanlin.o2o.util.wechat;
...
public class WechatUtil {
	...
	public static UserAccessToken getUserAccessToken(String code) throws IOException {
		// 测试号信息里的appId
		String appId = "wxdf83813397701394";
		log.debug("appId:" + appId);
		// 测试号信息里的appsecret
		String appsecret = "939f7a3318b7af3177bc817529d4ff51";
	...
	/**
	 * 将WechatUser里的信息转换成PersonInfo的信息并返回UserInfo实体类
	 * 
	 * @param user
	 * @return
	 */
	public static UserInfo getPersonInfoFromRequest(WechatUser user) {
		...
		personInfo.setImg(user.getHeadimgurl());
